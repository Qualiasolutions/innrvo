  ...
  return (
    <>
      ...
      <div className={`relative h-[100dvh] w-full flex flex-col transition-all duration-300 ${isLoading ? 'opacity-0' : 'opacity-100'} ${isInlineMode ? 'overflow-y-auto' : 'overflow-hidden'}`}>
        ...
        <div className={`fixed inset-y-0 left-0 z-[95] w-[280px] md:w-[320px] h-[100dvh] md:h-screen sidebar-premium border-r border-white/[0.06] flex flex-col overflow-hidden transition-all duration-300 ease-out ${showBurgerMenu ? 'translate-x-0' : '-translate-x-full'}`}>
