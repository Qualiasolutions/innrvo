...
const influencerProspects = [
  ...
  { name: 'Krystle', handle: 'krystle', followers: '45K', tags: ['Meditation', 'Wellness'], focus: 'YouTube meditation channel with 45K subscribers. Strong video content creator for guided meditation and wellness.' },
